...
export const DEMO_SPECIES: SpeciesSummary[] = [
  { id: 'sp-1', commonName: 'European Sea Bass', scientificName: 'Dicentrarchus labrax', localizedNames: { en: 'European Sea Bass', he: 'לוקוס ים' }, habitat: 'Coastal waters, rocky and sandy areas', environmentTypes: ['shore', 'pier'], conservationStatus: 'least_concern' },
  { id: 'sp-2', commonName: 'Bluefin Bream', scientificName: 'Pagrus caeruleostictus', localizedNames: { en: 'Bluefin Bream', he: 'דניס' }, habitat: 'Rocky reefs and sandy bottoms', environmentTypes: ['shore', 'rocks'], conservationStatus: 'least_concern' },
  ...
  { id: 'sp-6', commonName: 'Mackerel', scientificName: 'Scomber scombrus', localizedNames: { en: 'Mackerel', he: 'בורי' }, habitat: 'Pelagic, near surface', environmentTypes: ['pier', 'boat'], conservationStatus: 'least_concern' },
  { id: 'sp-7', commonName: 'Mullet', scientificName: 'Mugil cephalus', localizedNames: { en: 'Mullet', he: 'בורי' }, habitat: 'Estuaries and shallow coastal', environmentTypes: ['shore', 'harbor'], conservationStatus: 'least_concern' },
  { id: 'sp-8', commonName: 'Grouper', scientificName: 'Epinephelus marginatus', localizedNames: { en: 'Grouper', he: 'לוקוס' }, habitat: 'Rocky reefs', environmentTypes: ['rocks'], conservationStatus: 'vulnerable' },
  { id: 'sp-9', commonName: 'Sole', scientificName: 'Solea solea', localizedNames: { en: 'Common Sole', he: 'דג הלשון' }, habitat: 'Sandy and muddy bottoms', environmentTypes: ['shore'], conservationStatus: 'least_concern' },
  { id: 'sp-10', commonName: 'Amberjack', scientificName: 'Seriola dumerili', localizedNames: { en: 'Greater Amberjack', he: 'אינטיאס' }, habitat: 'Offshore reefs', environmentTypes: ['boat', 'pier'], conservationStatus: 'least_concern' },
  { id: 'sp-11', commonName: 'Barracuda', scientificName: 'Sphyraena sphyraena', localizedNames: { en: 'European Barracuda', he: 'ברקודה' }, habitat: 'Coastal pelagic', environmentTypes: ['pier', 'boat'], conservationStatus: 'least_concern' },
  { id: 'sp-12', commonName: 'Sardine', scientificName: 'Sardina pilchardus', localizedNames: { en: 'European Pilchard', he: 'סרדין' }, habitat: 'Pelagic schools', environmentTypes: ['pier', 'boat'], conservationStatus: 'least_concern' },
  { id: 'sp-13', commonName: 'Red Mullet', scientificName: 'Mullus barbatus', localizedNames: { en: 'Red Mullet', he: 'סולטאן ברבוניה' }, habitat: 'Sandy and muddy bottoms', environmentTypes: ['shore'], conservationStatus: 'least_concern' },
  { id: 'sp-14', commonName: 'White Seabream', scientificName: 'Diplodus sargus', localizedNames: { en: 'White Seabream', he: 'מרמור' }, habitat: 'Rocky and sandy areas', environmentTypes: ['shore', 'rocks'], conservationStatus: 'least_concern' },
